...
public class SudachiTokenizerTest {
    ...
    public static Object[][] querySurfaces() {
        return new Object[][] {
            ...
            {"The quick brown fox jumps over the lazy dog", new Object[] {"The", "quick", "brown", "fox", "jumps", "over", "the", "lazy", "dog"}},
            {"The quick 客室乗務員 brown fox jumps over the lazy dog 医薬品安全管理責任者", new Object[]
                    {"The", "quick", "客室", "乗務", "員", "brown", "fox", "jumps", "over", "the", "lazy", "dog", "医薬", "品", "安全", "管理", "責任", "者"}},
