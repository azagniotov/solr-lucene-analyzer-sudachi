...
public final class SudachiKatakanaStemFilter extends TokenFilter {
    ...
    public SudachiKatakanaStemFilter(final TokenStream input, final int minimumKatakanaLength) {
        super(input);
        if (minimumKatakanaLength < 1) {
            throw new IllegalArgumentException("minimumKatakanaLength must be >=1");
        }
        this.minimumKatakanaLength = minimumKatakanaLength;
        this.termAttr = addAttribute(CharTermAttribute.class);
        this.keywordAttr = addAttribute(KeywordAttribute.class);
    }

    public SudachiKatakanaStemFilter(final TokenStream input) {
